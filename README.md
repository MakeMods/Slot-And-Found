...
Use `/option SlotAndFound_Load true` to load last saved layout  
By default both commands use your characters name as the save key, but you can also override it by supplying a string
e.g
